...
module.exports = {
    ...
    // the body
    body: function (devices, gadgeteer) {
        var p = console.log;
...
// TODO:
                ...
                while(round <= maxNumOfRounds) {
                    ...
                    for(k in players) {
                        ...
                        console.log('ThrowAngle: '+currentPlayer.throwAngle);
                        if(currentPlayer.throwAngle < 143814)
                        {
                            gadgeteer.multicolorLed.red();
                        } else {
                            gadgeteer.multicolorLed.green();
                        }
